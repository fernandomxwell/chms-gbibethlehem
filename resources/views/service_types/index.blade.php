...
@section('content')
    ...
    <x-crud-table :items="$serviceTypes" :bulk-destroy-route="route('service_types.bulk-destroy')" :sortable="!request('search')">
        <x-slot:headers>
            @if(!request('search'))
    ...
    @include('layouts.delete-modals', [
        'items' => $serviceTypes,
        'permission' => 'service_types.delete',
        'destroyRoute' => 'service_types.destroy',
        'confirmText' => __('service_types.are_you_sure'),
    ])
...
@section('javascript')
    @include('layouts.reorder-script', [
        'reorderRoute' => route('service_types.reorder'),
        'successMsg' => __('service_types.success_reorder'),
        'errorMsg' => __('service_types.reorder_error'),
    ])
@endsection
@endif
